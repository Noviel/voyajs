...
function createProxy<T>(ep: Endpoint, path: (string | number | symbol)[] = []): Remote<T> {
...
export function windowEndpoint(w: PostMessageWithOrigin, context: EventSource = self): Endpoint {
  return {
